...
def lambda_handler(request, context):
    ...
    print('Directive.name and namespace-----')
    print(name)
    print(namespace)
    ...
    if namespace == 'Alexa.Discovery':
        ...
        if name == 'Discover':
            ...
            adr.add_payload_endpoint(
                friendly_name='BYD Car Door',
                endpoint_id='byd-switch-door',
                capabilities=[capability_alexa, capability_alexa_powercontroller])
            print('Name is Discover -----')
            print(adr)
